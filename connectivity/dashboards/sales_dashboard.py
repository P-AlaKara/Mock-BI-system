            ...
            [
                        ...
                        dbc.Row([
                            dbc.Col([
                                dmc.Group(
                                    ...
                                    className='stats',
                                    spacing='xs',
                                    style={'margin-top':10, 'flex-direction':'column', 'background-color': 'rgb(40, 37, 37)',
                                            'border': '2px solid rgb(40, 37, 37)', 'border-radius': '25px'},
                                    children=[
                                        html.Div(id='dummy-input', style={'display':'none'}),
                                        dmc.Text('Customers', size='xs', color='dimmed', style={'font-family':'IntegralCF-RegularOblique'}),
                                        dmc.Text(id='totalcust', size='xl', style={'font-family':'IntegralCF-ExtraBold'}),
                                        dmc.Text('Total Customers', id = 'churn_rate', size='xs', color='red', style={'font-family':'IntegralCF-RegularOblique'})
                                    ]
                                )
                            ]),
                            dbc.Col([
                                dmc.Group(
                                    ...
                                    children=[
                                        ...
                                        dmc.Text('Sales', size='xs', color='dimmed', style={'font-family':'IntegralCF-RegularOblique'}),
                                        dmc.Text(id='totalsales', size='xl', style={'font-family':'IntegralCF-ExtraBold'}),
                                        dmc.Text('December Sales', size='xs', color='red', style={'font-family':'IntegralCF-RegularOblique'})
                                    ]
                                )
                            ])
                        ]),
                            ...
                            dbc.Col([
                                dmc.Group(
                                    ...
                                    children=[
                                        ...
                                        dmc.Text('Revenue', size='xs', color='dimmed', style={'font-family':'IntegralCF-RegularOblique'}),
                                        dmc.Text(id='totalrevenue', size='xl', style={'font-family':'IntegralCF-ExtraBold'}),
                                        dmc.Text('December Revenue', size='xs', color='green', style={'font-family':'IntegralCF-RegularOblique'})
                                    ]
                                )
                            ]),
                            dbc.Col([
                                dmc.Group(
                                    ...
                                    children=[
                                        ...
                                        dmc.Text('Profit', size='xs', color='dimmed', style={'font-family':'IntegralCF-RegularOblique'}),
                                        dmc.Text(id='averageprofit', size='xl', style={'font-family':'IntegralCF-ExtraBold'}),
                                        dmc.Text('December Profit', size='xs', color='green', style={'font-family':'IntegralCF-RegularOblique'})
                                    ]
                                )
                            ])
                        ])
                ...
                dbc.Col(
                    [
                        ...
                        html.Div(className='six-columns content plot-container', children=[dcc.Graph(figure={}, id='controls-and-graph')]),
                    ]
                )
            ], style={'height': '50vh',
                   'margin-top': '1px', 
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        html.Div(
                            id='pie-chart', className='six-columns', children=[dcc.Graph(figure=figure2)]
                        )
                    ]
                )
